...
# describes the function Uninstall-NewRelicServerAgent
Describe 'Uninstall-NewRelicServerAgent' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Uninstall-NewRelicServerAgent } | Should Not Throw
    }
    It 'does something' {
      # call function Uninstall-NewRelicServerAgent and pipe the result to an assertion
      # Example:
      # Uninstall-NewRelicServerAgent | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Uninstall-NewRelicServerAgent | Should BeNullOrEmpty 
    }
  }
}
